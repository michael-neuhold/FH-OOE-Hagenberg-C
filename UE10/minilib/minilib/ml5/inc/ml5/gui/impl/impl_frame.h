//       $Id: impl_frame.h 607 2019-11-02 22:46:30Z p27116 $
//      $URL: https://svn01.fh-hagenberg.at/se/minilib/ml5/trunk/product/ml5/inc/ml5/gui/impl/impl_frame.h $
// $Revision: 607 $
...
class ML5_DLL_EXPORT frame final : public wxFrame {
   ...
   private:
      static bool menu_not_empty (std::string const & title, mitem_cont_t const & items);
