//       $Id: window.h 626 2020-01-12 16:28:28Z p20068 $
//      $URL: https://svn01.fh-hagenberg.at/se/minilib/ml5/trunk/product/ml5/inc/ml5/gui/window.h $
// $Revision: 626 $
...
class ML5_DLL_EXPORT window : public object, MI5_DERIVE (window, object) {
   ...
   public:
      ...
      int           get_width       () const;
      void          refresh         () const;
      void          restart_timer   (duration_t interval) const;
      void          set_status_text (std::string const & text) const;
      void          start_timer     (duration_t interval) const;
